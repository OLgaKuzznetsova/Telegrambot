...
public class ChatStateRepository {
    ...
    public String getIntendedAnswer(String chatId) { return intendedAnswerByChatId.get(chatId);}
    public boolean containsAnswerByChatId(String chatId) {
        return intendedAnswerByChatId.containsKey(chatId);
    }
    public void deleteAnswerByChatId(String chatId) { intendedAnswerByChatId.remove(chatId); }
